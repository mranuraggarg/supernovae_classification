...
# Sweep thresholds from 0 to 1 in small steps
thresholds = np.linspace(0.0, 1.0, 100)
f1_scores = [f1_score(Y_test_labels, (Y_pred_probs >= t).astype(int)) for t in thresholds]

# Find best threshold and best F1
best_idx = np.argmax(f1_scores)
best_threshold = thresholds[best_idx]
best_f1 = f1_scores[best_idx]

# Compare against default threshold of 0.5
default_f1 = f1_score(Y_test_labels, (Y_pred_probs >= 0.5).astype(int))
delta_f1 = best_f1 - default_f1

# Display result for reviewer insertion
print("\n=== Threshold Optimization Results ===")
print(f"Optimal threshold: {best_threshold:.3f}")
print(f"Default F1: {default_f1:.3f}")
print(f"Best F1: {best_f1:.3f}")
print(f"Delta F1: {delta_f1:.3f}")
print("=======================================")