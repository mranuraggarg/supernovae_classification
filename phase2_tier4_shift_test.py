"""Phase 2 Tier 4 Experiment E: distribution-shift sensitivity tests."""
...
CSV_PATH = f"{RESULTS_DIR}/shift_test_metrics.csv"
JSON_PATH = f"{RESULTS_DIR}/shift_test_metrics.json"
SUMMARY_PATH = f"{RESULTS_DIR}/shift_test_summary.md"
PLOT_PATH = f"{PLOTS_DIR}/phase2_tier4_shift_test.png"
...
def main() -> None:
    ...
    shift_splits = domain_splits_from_variants(context, variant_rows)
    ...
    plot_grouped_bars(
        ...
        ["f1_drop"],
        ["#b91c1c"],
        "Phase 2 Tier 4 Distribution Shift Test",
