"""Trial domain-swap experiment using ratio-based color features."""

from __future__ import annotations

import json

from phase2_tier4_common import DOMAIN_ORDER, plot_grouped_bars
...
CSV_PATH = f"{RESULTS_DIR}/trial_domain_swap_metrics.csv"
JSON_PATH = f"{RESULTS_DIR}/trial_domain_swap_metrics.json"
SUMMARY_PATH = f"{RESULTS_DIR}/trial_domain_swap_summary.md"
PLOT_PATH = f"{PLOTS_DIR}/phase2_tier4_trial_domain_swap.png"
