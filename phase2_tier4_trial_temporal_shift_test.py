"""Trial shift test using temporal-alignment features."""

from __future__ import annotations

import json

from phase2_tier4_common import SHIFT_ORDER, plot_grouped_bars, save_csv, save_json
...
CSV_PATH = f"{RESULTS_DIR}/trial_temporal_shift_test_metrics.csv"
JSON_PATH = f"{RESULTS_DIR}/trial_temporal_shift_test_metrics.json"
SUMMARY_PATH = f"{RESULTS_DIR}/trial_temporal_shift_test_summary.md"
PLOT_PATH = f"{PLOTS_DIR}/phase2_tier4_trial_temporal_shift_test.png"
...
def main() -> None:
    ...
    plot_grouped_bars(
        ...
        ["f1_drop"],
        ["#7c3aed"],
        "Phase 2 Tier 4 Trial Temporal Shift Test",
    ...
    payload = {
        "experiment": "trial_temporal_shift_test",
